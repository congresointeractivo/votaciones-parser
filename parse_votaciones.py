#!/usr/bin/python
# -*- coding: utf-8 -*-
import sys, os, subprocess, argparse, urllib, json
...
parser.add_argument('--outformat', choices=['json'], default='json', \
...
def split_data(line):
    ...
    >>> split_data("Base Mayoría: Votos Emitidos      Tipo de Mayoría: Más de la mitad     Tipo de Quorum: Más de la mitad")
...
if __name__ == '__main__':
    ...
    # write json file
    if pretty_print:
        json.dump(acta, fp=outfile, indent=4, separators=(',',': '), encoding='utf-8', ensure_ascii=False)
    else:
